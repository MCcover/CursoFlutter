...
class _TodoView extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var currentFilter = ref.watch(todoCurrentFilterProvider);
    var todoList = ref.watch(filteredTodosProvider);
      ...
      children: [
        ...
        SegmentedButton(
          ...
          onSelectionChanged: (value) {
            ref.read(todoCurrentFilterProvider.notifier).setFilter(value.first);
          },
        ),
