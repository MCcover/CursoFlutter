import 'package:cinemapedia/delegates/search_movie_delegate.dart';
...
class CustomAppbar extends ConsumerWidget {
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  ).then((movie) => navigateToMovie(context, movie));
                },
  ...
  void navigateToMovie(BuildContext context, Movie? movie) {
    if (movie == null) {
      return;
    }
